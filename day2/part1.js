...
function passwordValidator() {
    ...
    for (i = 0; i < passwordsMapped.length; i++) {
        ...
        let lowerBound = parseInt(integerStrings[0]);
        let upperBound = parseInt(integerStrings[1]);
        ...
        // (mainStr.split("c").length - 1) to count number of occurrences
        // of character in pwd
        let passwordToValidate = passwordsMapped[i][2];
        let numOfOccurrences = passwordToValidate.split(charToCheck).length - 1;

        if (numOfOccurrences >= lowerBound && numOfOccurrences <= upperBound) {
            counter++;
        }
    }
    console.log(counter);
...
// Advent of Code 2020 Day 2, Part 1: Password Philosophy
//                  _...Q._
//                .'       '.
//               /           \
//              ;.-""""--.._ |
